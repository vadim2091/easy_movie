...
def create_app():
    ...
    # ✅ **ВАЖНО: создаём таблицы и наполняем их ПОСЛЕ инициализации db**
    with app.app_context():
        # Сначала создаём все таблицы (если их нет)
        db.create_all()
        print("✅ Таблицы созданы (если не существовали)")

        # Теперь можно безопасно работать с моделями
...
Ссылка: https://trk.ppdu.ru/click/pKYWYSuY?erid=Kra23uVC3''',
    ...
    return app  # ← ВАЖНО: return ДОЛЖЕН БЫТЬ НА ЭТОМ УРОВНЕ, внутри функции